...
import com.example.rus.cleanweather.di.modules.DetailedProviderModule;
...
@DataProviderScope
@Component(modules = {AdapterModule.class, PresenterModule.class, InteractorModule.class, DataProviderModule.class,ContextModule.class, DetailedProviderModule.class})
public interface AppComponent {
    void inject(MainActivity mainActivity);
    void inject(DetailedActivityMVP detailedActivityMVP);
}
